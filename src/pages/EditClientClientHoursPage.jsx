...
const EditClientClientHoursPage = () => {
...
const [client_id, setClientId] = useState(0);const [hour, setHour] = useState(0);const [date, setDate] = useState('');const [description, setDescription] = useState('');
...
export default EditClientClientHoursPage;
