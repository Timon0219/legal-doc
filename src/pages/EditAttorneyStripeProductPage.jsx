...
const EditAttorneyStripeProductPage = () => {
...
const [name, setName] = useState('');const [stripe_id, setStripeId] = useState('');const [object, setObject] = useState('');
  ...
  const onSubmit = async (data) => {
    try {
      ...
      if (!result.error) {
        ...
        navigate("/attorney/stripe_product");
      } else {
...
export default EditAttorneyStripeProductPage;
