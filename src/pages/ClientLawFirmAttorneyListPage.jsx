...
const ClientLawFirmAttorneyListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/client/add-law_firm_attorney"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/client/edit-law_firm_attorney/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default ClientLawFirmAttorneyListPage;
