...
const LawFirmStripeSettingListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/law_firm/add-stripe_setting"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/law_firm/edit-stripe_setting/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default LawFirmStripeSettingListPage;
