      ...
      <div className="grid grid-cols-2 gap-6 ">
        {contracts && contracts.nda_url && (
          <div className="">
            ...
            <Link
              ...
              to={`/lawfirm/view_nda_update/${contracts.id}/nda`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.nda1_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/lawfirm/view_nda_update/${contracts.id}/nda1`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.nda2_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/lawfirm/view_nda_update/${contracts.id}/nda2`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.nda3_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/lawfirm/view_nda_update/${contracts.id}/nda3`}
            >
              Change
            </Link>
            <embed
...
export default LawfirmViewNDAListPage;
