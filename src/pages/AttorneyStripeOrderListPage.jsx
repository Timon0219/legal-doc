...
const AttorneyStripeOrderListPage = () => {
  ...
  const schema = yup.object({
      ...
      price_id: yup.number().positive().integer(),
...
let id = getNonNullValue(data.id);
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">StripeOrder Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">StripeOrder</h4>
          <AddButton link={"/attorney/add-stripe_order"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-stripe_order/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyStripeOrderListPage;
