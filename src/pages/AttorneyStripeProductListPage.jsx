...
const AttorneyStripeProductListPage = () => {
...
let id = getNonNullValue(data.id);
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">StripeProduct Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">StripeProduct</h4>
          <AddButton link={"/attorney/add-stripe_product"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-stripe_product/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyStripeProductListPage;
