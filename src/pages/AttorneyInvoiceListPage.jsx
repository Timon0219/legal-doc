...
let id = getNonNullValue(data.id);
    ...
    let pay_date = getNonNullValue(data.pay_date);
    let status = getNonNullValue(data.status);
    let invoice = getNonNullValue(data.invoice);
    let filter = {
      id,
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/attorney/add-invoice"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-invoice/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyInvoiceListPage;
