...
const ClientContractDocumentHoursListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/client/add-contract_document_hours"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/client/edit-contract_document_hours/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default ClientContractDocumentHoursListPage;
