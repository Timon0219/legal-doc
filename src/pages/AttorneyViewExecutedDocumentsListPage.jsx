...
const AttorneyViewExecutedDocumentsListPage = () => {
      ...
      <div className="grid grid-cols-2 gap-6 ">
        {contracts && contracts.executed_doc_url && (
          <div className="">
            ...
            <Link
              ...
              to={`/attorney/view_executed_document_update/${contracts.id}/executed_doc`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.executed_doc2_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/attorney/view_executed_document_update/${contracts.id}/executed_doc2`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.executed_doc3_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/attorney/view_executed_document_update/${contracts.id}/executed_doc3`}
            >
              Change
            </Link>
...
export default AttorneyViewExecutedDocumentsListPage;
