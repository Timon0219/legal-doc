...
const AddLawFirmStripeCheckoutPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (!result.error) {
        ...
        navigate("/law_firm/stripe_checkout");
      } else {
  ...
  return (
    <div className=" shadow-md rounded  mx-auto p-5">
      <h4 className="text-2xl font-medium">Add StripeCheckout</h4>
...
export default AddLawFirmStripeCheckoutPage;
