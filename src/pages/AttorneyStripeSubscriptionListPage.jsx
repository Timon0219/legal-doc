...
const AttorneyStripeSubscriptionListPage = () => {
...
let id = getNonNullValue(data.id);
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">StripeSubscription Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">StripeSubscription</h4>
          <AddButton link={"/attorney/add-stripe_subscription"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-stripe_subscription/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyStripeSubscriptionListPage;
