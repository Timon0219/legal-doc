...
const AttorneyViewDocumentsListPage = () => {
      ...
      <div className="grid grid-cols-2 gap-6 ">
        {contracts && contracts.doc_url && (
          <div className="">
            ...
            <Link
              ...
              to={`/attorney/contracts_document_update/${contracts.id}/doc`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.doc1_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/attorney/contracts_document_update/${contracts.id}/doc1`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.doc2_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/attorney/contracts_document_update/${contracts.id}/doc2`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.doc3_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/attorney/contracts_document_update/${contracts.id}/doc3`}
            >
              Change
            </Link>
...
export default AttorneyViewDocumentsListPage;
