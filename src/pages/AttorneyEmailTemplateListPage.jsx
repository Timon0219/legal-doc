...
const AttorneyEmailTemplateListPage = () => {
  ...
  const schema = yup.object({
      ...
      email_id: yup.number().positive().integer(),
...
let id = getNonNullValue(data.id);
    let email_id = getNonNullValue(data.email_id);
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">EmailTemplate Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">EmailTemplate</h4>
          <AddButton link={"/attorney/add-email_template"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-email_template/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyEmailTemplateListPage;
