...
const [client_id, setClientId] = useState(0);const [charged_amount, setChargedAmount] = useState(0);const [fork_fee, setForkFee] = useState(0);const [payout_amount, setPayoutAmount] = useState(0);const [pay_date, setPayDate] = useState('');const [status, setStatus] = useState(0);const [invoice, setInvoice] = useState('');
    ...
    (async function () {
      try {
        ...
        if (!result.error) {
            ...
            setValue('pay_date', result.model.pay_date);
            setValue('status', result.model.status);
            setValue('invoice', result.model.invoice);
            ...
            setPayDate(result.model.pay_date);
            setStatus(result.model.status);
            setInvoice(result.model.invoice);
  ...
  return (
    <div className=" shadow-md rounded   mx-auto p-5">
      <h4 className="text-2xl font-medium">Edit Invoice</h4>
...
export default EditLawFirmInvoicePage;
