      ...
      <form className="p-5 bg-white shadow rounded mb-10" onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="filter-form-holder mt-10 flex flex-wrap">
          ...
          <div className="mb-4 w-full md:w-1/2 pr-2 pl-2">
            ...
            <select className="shadow appearance-none border  rounded w-full py-2 px-3 text-gray-700 mb-3 leading-tight focus:outline-none focus:shadow-outline" {...register("type")}>
