...
const SubclientLoginPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      navigate("/subclient/dashboard");
      return;
      // const result = await sdk.login(data.email, data.password, "subclient");
      console.log(result);
      if (!result.error) {
        // dispatch({
        //   type: "LOGIN",
        ...
        // navigate(`/two_fa/code?role=subclient&qr_code=${result.qr_code}`);
        const body = encodeURI(
          `${location.origin}/two_fa?role=subclient&token=${result.one_time_token}`
        );
...
export default SubclientLoginPage;
