...
const AdminStripeInvoicesListPageV2 = () => {
  ...
  async function getData(pageNum, limitNum, data) {
    try {
      const { list, total, limit, num_pages, page, error, message } = await sdk.getStripeInvoicesV2({ page: pageNum, limit: limitNum }, data);
...
export default AdminStripeInvoicesListPageV2;
