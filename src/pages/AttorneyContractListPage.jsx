...
const columns = [
  ...
  },
  {
    ...
    mapping: [
      ...
      "escalated",
      "executed",
      "sent across 1st round edits",
      "sent across 2nd round edits",
      "sent across 3rd round edits",
    ],
  },
  {
    header: "DocTypeId",
...
const AttorneyContractListPage = () => {
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-contract/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyContractListPage;
