...
const SubclientBillingPage = () => {
  ...
  useEffect(() => {
    if (clientId) getData(1, pageSize);
  }, [clientId]);
    ...
    <>
      <div className="p-5 bg-white shadow rounded mb-10">
        ...
        <div className="min-w-full  border-b border-gray-200 ">
          <div className="min-w-full overflow-x-auto block w-full max-w-[1029px]">
                            ...
                            >
                              <div className="flex flex-col items-start ">
                                <button
                                  ...
                                  onClick={() => {
                                    navigate(
                                      `/subclient/pay/${row.id}?client_id=${clientId}&generated_at=${row.generated_at}`,
                                      {
                                        state: row,
                                      }
                                    );
                            ...
                            >
                              <div className="flex flex-col items-start">
                                <button
                                  ...
                                  onClick={() => {
                                    navigate(
                                      "/subclient/edit-contract_tag/" + row.id,
                                      {
                                        state: row,
                                      }
                                    );
      ...
      <div className="p-5 bg-white shadow rounded mb-10">
        ...
        <div className="shadow  border-b border-gray-200 min-w-full">
          <div className="overflow-x-auto block w-full max-w-[1029px] min-w-full">
            <table className="min-w-full divide-y divide-gray-200">
              <thead className="bg-gray-50">
                <tr>
                              ...
                              >
                                <div className="flex flex-col items-start ">
                                  <button
                                    ...
                                    onClick={() => {
                                      navigate(
                                        `/subclient/billing/${row.id}?client_id=${clientId}&generated_at=${row.generated_at}`,
                                        {
                                          state: row,
                                        }
                                      );
...
export default SubclientBillingPage;
