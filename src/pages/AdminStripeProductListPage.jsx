...
const AdminStripeProductListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/admin/add-stripe_product"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/admin/edit-stripe_product/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AdminStripeProductListPage;
