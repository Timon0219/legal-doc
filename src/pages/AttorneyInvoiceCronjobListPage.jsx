...
const AttorneyInvoiceCronjobListPage = () => {
...
let id = getNonNullValue(data.id);
    ...
    let charged_amount = getNonNullValue(data.charged_amount);
    let fork_fee = getNonNullValue(data.fork_fee);
    let payout_amount = getNonNullValue(data.payout_amount);
    let filter = {
      id,
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">InvoiceCronjob Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">InvoiceCronjob</h4>
          <AddButton link={"/attorney/add-invoice_cronjob"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-invoice_cronjob/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyInvoiceCronjobListPage;
