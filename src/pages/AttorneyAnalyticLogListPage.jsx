...
const AttorneyAnalyticLogListPage = () => {
    ...
    <>
      ...
      >
        ...
        <div className="mb-4 w-full md:w-1/2 pr-2 pl-2">
          ...
          <input
            ...
            {...register("path")}
            className={`"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              errors.path?.message ? "border-red-500" : ""
            }`}
          />
          <p className="text-red-500 text-xs italic">
            {errors.path?.message}
        ...
        <div className="mb-4 w-full md:w-1/2 pr-2 pl-2">
          ...
          <input
            ...
            {...register("hostname")}
            className={`"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              errors.hostname?.message ? "border-red-500" : ""
            }`}
          />
          <p className="text-red-500 text-xs italic">
        ...
        <div className="mb-4 w-full md:w-1/2 pr-2 pl-2">
          ...
          <input
            ...
            {...register("ip")}
            className={`"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              errors.ip?.message ? "border-red-500" : ""
            }`}
          />
          <p className="text-red-500 text-xs italic">
            {errors.ip?.message}
        ...
        <div className="mb-4 w-full md:w-1/2 pr-2 pl-2">
          ...
          <input
            ...
            {...register("browser")}
            className={`"shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
              errors.browser?.message ? "border-red-500" : ""
            }`}
          />
          <p className="text-red-500 text-xs italic">
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/attorney/add-analytic_log"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-analytic_log/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyAnalyticLogListPage;
