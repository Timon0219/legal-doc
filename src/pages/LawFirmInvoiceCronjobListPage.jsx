...
const LawFirmInvoiceCronjobListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/law_firm/add-invoice_cronjob"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/law_firm/edit-invoice_cronjob/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default LawFirmInvoiceCronjobListPage;
