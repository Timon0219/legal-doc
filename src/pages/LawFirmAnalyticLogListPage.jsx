...
const LawFirmAnalyticLogListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/law_firm/add-analytic_log"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/law_firm/edit-analytic_log/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default LawFirmAnalyticLogListPage;
