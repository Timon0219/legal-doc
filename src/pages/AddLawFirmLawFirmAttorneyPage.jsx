...
const AddLawFirmLawFirmAttorneyPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (!result.error) {
        ...
        navigate("/law_firm/law_firm_attorney");
      } else {
  ...
  return (
    <div className=" shadow-md rounded  mx-auto p-5">
      <h4 className="text-2xl font-medium">Add LawFirmAttorney</h4>
...
export default AddLawFirmLawFirmAttorneyPage;
