...
const LawfirmViewPlaybookListPage = () => {
      ...
      <div className="grid grid-cols-2 gap-6 ">
        {contracts && contracts.playbook_url && (
          <div className="">
            ...
            <Link
              ...
              to={`/lawfirm/view_playbook_update/${contracts.id}/playbook`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.playbook1_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/lawfirm/view_playbook_update/${contracts.id}/playbook1`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.playbook2_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/lawfirm/view_playbook_update/${contracts.id}/playbook2`}
            >
              Change
            </Link>
        ...
        {contracts && contracts.playbook3_url && (
          <div className="">
            ...
            <Link
              className="text-lg text-[#4a5fe6] underline capitalize ml-6 "
              to={`/lawfirm/view_playbook_update/${contracts.id}/playbook3`}
            >
              Change
            </Link>
...
export default LawfirmViewPlaybookListPage;
