...
const AttorneyContractsActivityLogListPage = () => {
      ...
      const result = await sdk.callRestAPI(
        {
          where: data
            ? {
                ...
                status: data.status ? JSON.parse(data.status) : null,
                attorney_id: data.user_id ? data.user_id : null,
                // attorney_id: 5,
              }
            : null,
          page: pageNum,
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">ActivityLog Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">ActivityLog</h4>
                          ...
                          return (
                            ...
                            >
                              <button
                                ...
                                onClick={() => {
                                  navigate(
                                    "/attorney/edit-activity_log/" + row.id,
                                    {
                                      state: row,
                                    }
                                  );
...
export default AttorneyContractsActivityLogListPage;
