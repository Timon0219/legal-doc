...
let id = getNonNullValue(data.id);
    ...
    let input_type = getNonNullValue(data.input_type);
    let filter = {
      id,
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">Tag Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">Tag</h4>
          <AddButton link={"/attorney/add-tag"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-tag/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyTagListPage;
