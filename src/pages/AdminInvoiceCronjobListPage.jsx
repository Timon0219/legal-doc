...
const AdminInvoiceCronjobListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/admin/add-invoice_cronjob"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/admin/edit-invoice_cronjob/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AdminInvoiceCronjobListPage;
