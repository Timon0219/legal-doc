...
const ClientStripeSubscriptionListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/client/add-stripe_subscription"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/client/edit-stripe_subscription/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default ClientStripeSubscriptionListPage;
