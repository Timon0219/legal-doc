...
const AttorneyLawFirmClientListPage = () => {
...
let id = getNonNullValue(data.id);
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">LawFirmClient Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">LawFirmClient</h4>
          <AddButton link={"/attorney/add-law_firm_client"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-law_firm_client/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyLawFirmClientListPage;
