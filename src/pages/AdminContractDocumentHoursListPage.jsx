...
const AdminContractDocumentHoursListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/admin/add-contract_document_hours"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/admin/edit-contract_document_hours/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AdminContractDocumentHoursListPage;
