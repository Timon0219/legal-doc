...
const AttorneyContractDocumentHoursListPage = () => {
...
let id = getNonNullValue(data.id);
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">ContractDocumentHours Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">ContractDocumentHours</h4>
          <AddButton link={"/attorney/add-contract_document_hours"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-contract_document_hours/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyContractDocumentHoursListPage;
