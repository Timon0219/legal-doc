...
const SubclientPendingContractsListPage = () => {
  ...
  async function getData(pageNum, limitNum, data) {
    ...
    try {
      ...
      console.log(
        "DATA",
        list.filter((item) => item.contract_type === 0)
      );
      setPageSize(limit);
  ...
  async function getSubclient() {
    try {
      ...
      const { list } = result;
      console.log("after getting subclient", list, user_id);
  ...
  React.useEffect(() => {
    ...
    if (subclient) {
      (async function () {
        await getData(1, pageSize, { user_id: subclient.client_id, status: 0 });
      })();
    }
                    ...
                    <tr key={i}>
                      <td className="2xl:hidden px-6 py-4 whitespace-nowrap">
                        <div className="flex flex-col items-start ">
                          ...
                          <Link
                            to={`/subclient/edit-contract/${row.id}`}
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        {moment(row.create).format("MM/DD/yyyy")}
                      </td>
                      <td className="px-6 py-4 whitespace-nowrap">
                      ...
                      <td className="px-6 py-4 whitespace-nowrap">
                        <div className="flex flex-col items-start">
                          <button
                            ...
                            onClick={() => {
                              navigate("/subclient/edit_contracts/" + row.id, {
                                state: row,
                              });
                            }}
                          >
...
export default SubclientPendingContractsListPage;
