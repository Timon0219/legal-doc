...
const AdminStripeSubscriptionListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/admin/add-stripe_subscription"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/admin/edit-stripe_subscription/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AdminStripeSubscriptionListPage;
