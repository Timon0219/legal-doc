...
const AddAttorneyClientHoursPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (!result.error) {
        ...
        navigate("/attorney/client_hours");
      } else {
  ...
  return (
    <div className=" shadow-md rounded  mx-auto p-5">
      <h4 className="text-2xl font-medium">Add ClientHours</h4>
...
export default AddAttorneyClientHoursPage;
