...
const AddAttorneyContractTagPage = () => {
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (!result.error) {
        ...
        navigate("/attorney/contract_tag");
      } else {
  ...
  return (
    <div className=" shadow-md rounded  mx-auto p-5">
      <h4 className="text-2xl font-medium">Add ContractTag</h4>
...
export default AddAttorneyContractTagPage;
