...
const AttorneyClientRateListPage = () => {
...
let id = getNonNullValue(data.id);
    ...
    let rate = getNonNullValue(data.rate);
    let filter = {
      id,
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">ClientRate Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">ClientRate</h4>
          <AddButton link={"/attorney/add-client_rate"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-client_rate/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyClientRateListPage;
