...
const LawFirmStripeOrderListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/law_firm/add-stripe_order"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/law_firm/edit-stripe_order/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default LawFirmStripeOrderListPage;
