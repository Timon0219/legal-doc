...
const ClientDocumentUploadListPage = () => {
            ...
            sdk
              ...
              .then((res) => {
                ...
                if (!res.error) {
                  ...
                  navigate("/lawfirm/pending_contracts", { replace: true });
                }
              })
              .catch((err) => {
                setLoading(false);
...
export default ClientDocumentUploadListPage;
