...
const lawfirm_id = parseInt(localStorage.getItem("user"));

const AttorneyDocumentsListPage = () => {
  ...
  async function getData(pageNum, limitNum, data) {
    try {
      ...
      setCurrentTableData(list.filter((item) => item.client_id == lawfirm_id));
      setPageSize(limit);
...
export default AttorneyDocumentsListPage;
