...
const AttorneyStripeWebhookListPage = () => {
    ...
    <>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          ...
          <AddButton link={"/attorney/add-stripe_webhook"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-stripe_webhook/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyStripeWebhookListPage;
