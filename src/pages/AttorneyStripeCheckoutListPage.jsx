...
const AttorneyStripeCheckoutListPage = () => {
...
let id = getNonNullValue(data.id);
  ...
  return (
    <>
      ...
      >
        <h4 className="text-2xl font-medium">StripeCheckout Search</h4>
      ...
      <div className="overflow-x-auto  p-5 bg-white shadow rounded">
        <div className="mb-3 text-center justify-between w-full flex  ">
          <h4 className="text-2xl font-medium">StripeCheckout</h4>
          <AddButton link={"/attorney/add-stripe_checkout"} />
        </div>
                        ...
                        return (
                          ...
                          >
                            <button
                              className="text-xs"
                              onClick={() => {
                                navigate("/attorney/edit-stripe_checkout/" + row.id, {
                                  state: row,
                                });
                              }}
                            >
...
export default AttorneyStripeCheckoutListPage;
